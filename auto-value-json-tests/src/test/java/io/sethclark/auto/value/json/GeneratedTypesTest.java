  ...
  @Test public void simpleObject() throws JSONException {
    JSONObject testJsonObj = new JSONObject(
        "{" + "    \"aInt\": 1," + "    \"aByte\": 4," + "    \"aShort\": 6,"
            + "    \"aDouble\": 1.2," + "    \"aFloat\": 1.0,"
            + "    \"aLong\": 1123581321345589," + "    \"aBoolean\": true,"
            + "    \"aChar\":\"d\"," + "    \"aIntObj\": 2," + "    \"aByteObj\": 16,"
            + "    \"aShortObj\": 5," + "    \"aDoubleObj\": 1.3," + "    \"aFloatObj\": 1.1,"
            + "    \"aLongObj\": 9855431231853211," + "    \"aBooleanObj\": false,"
            + "    \"aCharObj\":\"s\"," + "    \"aString\": \"String\"" + "}");
